          ...
          <div class="container">
            <div class="row p-5">
              <div
                ...
                style="background-image: url(./assets/img/carousel/main1.jpg)"
              ></div>
            </div>
          </div>
        </div>
        <div class="carousel-item">
          <div class="container">
            <div class="row p-5">
              <div
                class="mx-auto col-md-8 col-lg-6 order-lg-last carousel-background"
                style="background-image: url(./assets/img/carousel/main2.jpg)"
              ></div>
            </div>
          </div>
        </div>
        <div class="carousel-item">
          <div class="container">
            <div class="row p-5">
              <div
                class="mx-auto col-md-8 col-lg-6 order-lg-last carousel-background"
                style="background-image: url(./assets/img/carousel/main3.jpg)"
              ></div>
            </div>
          </div>
        </div>
