	...
	<footer class="bg-dark" id="tempaltemo_footer">
			...
			<div class="row text-light">
				...
				<div class="col-auto">
					<ul class="nav justify-content-end">
						...
						<li class="nav-item"><a class="nav-link disabled">오시는길</a></li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div class="w-100 bg-black py-3">
			<div class="container">
				<div class="row pt-2">
					<div class="col-12">
						<p class="text-left text-light">Copyright &copy; 2023 Mammoth
							Trip | Designed CHL&JWJ</p>
					</div>
				</div>
			</div>
		</div>
...
<script src="${root}/assets/js/templatemo.js"></script>
<!-- End Script -->
</html>