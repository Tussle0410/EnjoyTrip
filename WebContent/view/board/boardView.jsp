				...
				<div class="col-lg-5 mt-5 article-main-div">
					<div class="card mb-3">
						<img class="card-img img-fluid card-main-img"
							src="${imgInfo[0].img}" alt="Card image cap" id="product-detail" />
					</div>
					<div class="row">
						<!--Start Controls-->
						...
						<div id="multi-item-example"
							...
							<div class="carousel-inner product-links-wap" role="listbox">
								...
								<div class="carousel-item active">
									<div class="row">
										<c:forEach var="i" begin="0"
											end="${imgInfo.size()-1 > 2 ? 2 : imgInfo.size()-1}">
											<div class="col-4">
												<a href="#"> <img
													class="card-img img-fluid card-slide-img"
													src="${imgInfo[i].img}" alt="Product Image 1" />
												</a>
											</div>
										</c:forEach>
									</div>
								...
								<!--Second slide-->
								<c:if test="${imgInfo.size()>=3}">
									<div class="carousel-item">
										<div class="row">
											<c:forEach var="i" begin="3"
												end="${imgInfo.size()-1>5 ? 5 : imgInfo.size()-1}">
												<div class="col-4">
													<a href="#"> <img
														class="card-img img-fluid card-slide-img"
														src="${imgInfo[i].img}" alt="Product Image 1" />
						...
						<div card-body pt-5 pb-5>
							...
							<div>
								<div id="comment-text"
									...
									작성자 : ${articleInfo.email}</div>
								<div class="fs-5 mb-5" id="comment-text">조회수 :
									${articleInfo.hit}</div>
							</div>
							...
							<div class="d-flex" style="justify-content: space-between">
								<div id="heart-box">
									<c:if test="${articleInfo.heartFlag == false}">
										<button id="article-heart-btn"
											class="btn btn-outline-dark flex-shrink-0" value="false"
											type="button">
									...
									<c:if test="${articleInfo.heartFlag == true}">
										<button id="article-heart-btn"
											class="btn flex-shrink-0 bg-success bg-gradient" value="true"
											type="button">
											<i class="bi bi-hand-thumbs-up me-1"></i> 좋아요!!
										</button>
									</c:if>
