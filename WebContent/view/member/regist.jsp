      ...
      <div id="login-div">
        ...
        <div>
          <form method="post" action="${root}/member" id="sign-form">
            ...
            <input name="email" class="input-text" type="text" placeholder="Your Email" required />
            <input
              name="name"
              class="input-text"
              type="text"
            ...
            <div id="personal-info_agree">
              <label><input type="checkbox" required />Privacy Statement</label>
            </div>
            <input type="submit" id="sign-btn" value="Sign Up" />
          </form>
        </div>
        <div id="sign-desc">Already have an account<a href="login.jsp">Login</a></div>
      </div>
    </div>
  </body>
</html>
